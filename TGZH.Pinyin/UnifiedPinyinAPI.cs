...
namespace TGZH.Pinyin
{
    ...
    public static class UnifiedPinyinApi
    {
        ...
        public static async Task<string> GetTextPinyinAsync(string text, PinyinFormat format = PinyinFormat.WithToneMark, string separator = " ")
        {
            await InitializeOnDemandAsync();
        ...
        public static async Task<string> ProcessLargeTextAsync(string text, PinyinFormat format = PinyinFormat.WithToneMark, string separator = " ")
        {
            await InitializeOnDemandAsync();
